...
package org.opevel.web.servlets;
 ...
 */
public class TestGoogleService extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TestGoogleService</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1><a href='/testgoogleservice'></a></h1>");
            out.println("</body>");
            out.println("</html>");
        } finally { 
            out.close();
